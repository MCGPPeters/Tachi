...
var Middleware = (function () {
    function Middleware(appFunc) {
        this.appFunc = appFunc;
        this.invoke = this.invoke.bind(this);
    }
    Middleware.prototype.invoke = function (request) {
        ...
        this.appFunc(owinRequestData, function (failure, owinResponseData) {
            ...
            request.on("response", function (response) {
                ...
                for (var key in owinEnvironmentResponseHeaders) {
