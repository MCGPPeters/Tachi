...
describe("an http client", function () {
    it("/OK should return the status code ok", function (done) {
    ...
    it("/NotFound should return the status code NotFound", function (done) {
        var appFunc = edge.func("./../../tests/eVision.InteractivePnid.Tests.Fixtures/bin/debug/eVision.InteractivePnid.Tests.Fixtures.dll");
        var middleware = new Owin.Middleware(appFunc);
        request
            .get("/NotFound")
...
//# sourceMappingURL=OwinMiddlewareScenarios.js.map